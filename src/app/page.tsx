...
export default async function Home() {
  ...
  return (
    <main className="">
      ...
      <MobileNav/>
      <div className='bg-yellow-400 min-h-screen max-w-7xl mx-auto rounded-t-3xl pt-3 pb-3'>
        <div className=' justify-center p-4 mt-5 mx-4 rounded-lg'>
          <div className='sm:flex sm:flex-row sm:max-w-full'>
            <img className='rounded-md drop-shadow-xl object-center mx-auto' src="https://upload.wikimedia.org/wikipedia/commons/3/3f/Adnan_Purichta_Ichsan%2C_Bupati_Gowa_%28Periode_II%29.png" alt="" />
            <div className='sm:flex sm:flex-col  sm:px-4'>
              <p className='pt-4 text-white text-3xl font-extrabold'>Website Desa Tamannyeleng</p>            
              <p className='pt-4 text-white text-lg font-medium'>
        ...
        <div className='bg-white p-4 mt-5 max-w-6xl mx-auto'>
